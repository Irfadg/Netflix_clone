...
class _$CounterStateImpl implements _CounterState {
  const _$CounterStateImpl({required this.count, required this.id});
  ...
  @override
  String toString() {
    return 'CounterState(count: $count, id: $id)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, count, id);
...
abstract class _CounterState implements CounterState {
  const factory _CounterState(
      ...
      required final String id}) = _$CounterStateImpl;
